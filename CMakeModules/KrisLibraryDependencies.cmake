...
IF(USE_OMPL)
  ...
  IF(OMPL_FOUND)
    ...
    SET(KRISLIBRARY_DEFINITIONS ${KRISLIBRARY_DEFINITIONS} -lompl)
    SET(KRISLIBRARY_DEFINITIONS ${KRISLIBRARY_DEFINITIONS} -USE_OMPL)
    SET(KRISLIBRARY_DEFINITIONS ${KRISLIBRARY_DEFINITIONS} -L/usr/local/lib/x86_64-linux-gnu/libompl.so)
    ...
    SET(KRISLIBRARY_LIBRARIES ${KRISLIBRARY_LIBRARIES} ompl)
    MESSAGE(${OMPL_LIBRARIES})
    MESSAGE(${KRISLIBRARY_LIBRARIES})
    #SET(KRISLIBRARY_LIBRARIES ${KRISLIBRARY_LIBRARIES} pthreads)
  ELSE(OMPL_FOUND)
